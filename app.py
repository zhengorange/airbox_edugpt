...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    ...
    with gr.Tab("🔥️主页"):
        ...
        with gr.Row():
            with gr.Column():
                model = gr.Radio(choices=["chatglm2"], label="模型选择", value="chatglm2", interactive=True)
                bilibili_SESSDATA = gr.Textbox(label="Bilibili SESSDATA(可选)", value="cececcbc%2C1713176919%2C58317%2Aa2CjCR77D3VVZLJZXlxz7NeWduLGlg57-Vc2j-mjVPDtw945mhDOmYt8Sm8vn2IkaNoBgSVjRYbWEtZzNWN0hnRUoydXhaRC1VN0xJaGdjOG5BMUhYcXRPSGFhVDNBX3JvdG8tbTk4VkxwNzFab21KaENjVkJJXzZEN3l2bThBMGFlMGpxaHRpWUZnIIEC")
        ...
        gr.Button("确定").click(fn=set_env, inputs=[model, bilibili_SESSDATA], outputs=info)
